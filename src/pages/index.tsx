        ...
        <>
            <Box sx={containerStyle}>
                ...
                <Box sx={rightColumnStyle}>
                    <Typography fontSize={"3rem"} color={"red"} fontWeight={500} variant="h2">Epicicloidi con Geogebra</Typography>
                    <Typography fontSize={"2rem"} variant="h3">Esplora nuove intuizioni</Typography>
                </Box>
            </Box>
            <Divider />
